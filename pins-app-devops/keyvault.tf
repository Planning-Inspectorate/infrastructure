...
#   tenant_id    = data.azurerm_client_config.current.tenant_id
#   object_id    = data.azuread_group.WHATEVERGROUP.object_id 
...
#     ]
#     storage_permissions = [
#       "get","backup", "delete", "list", "purge", "recover", "restore", "update", "set"
#     ]
# }
...
#     principal_id         = data.azuread_group.SOME-GROUP-NAME.object_id 
